...
TORCH_LIBRARY_FRAGMENT(TORCH_EXTENSION_NAME, ops) {
  ...
  handle =
      c10::Dispatcher::singleton().findSchema({"_C::paged_attention_v1", ""});
  if (!handle.has_value()) {
    ops.def(
        "paged_attention_v1("
  ...
  // TODO modify to tensor
  handle =
      c10::Dispatcher::singleton().findSchema({"_C::paged_attention_v2", ""});
  if (!handle.has_value()) {
    ops.def(
        "paged_attention_v2("
  ...
  handle =
      c10::Dispatcher::singleton().findSchema({"_C::silu_and_mul_pad", ""});
  if (!handle.has_value()) {
    ops.def(
        "silu_and_mul_pad(Tensor(a!) out, Tensor input, Tensor size) -> ()");
  }
  ops.impl("silu_and_mul_pad", torch::kPrivateUse1, &silu_and_mul_pad);

  handle = c10::Dispatcher::singleton().findSchema({"_C::mul_and_silu", ""});
  if (!handle.has_value()) {
  ...
  handle =
      c10::Dispatcher::singleton().findSchema({"_C::gelu_tanh_and_mul", ""});
  if (!handle.has_value()) {
  ...
  handle = c10::Dispatcher::singleton().findSchema({"_C::fatrelu_and_mul", ""});
  if (!handle.has_value()) {
    ops.def(
  ...
  handle = c10::Dispatcher::singleton().findSchema({"_C::gelu_new", ""});
  if (!handle.has_value()) {
  ...
  handle = c10::Dispatcher::singleton().findSchema({"_C::gelu_fast", ""});
  if (!handle.has_value()) {
  ...
  handle = c10::Dispatcher::singleton().findSchema({"_C::gelu_quick", ""});
  if (!handle.has_value()) {
  ...
  handle =
      c10::Dispatcher::singleton().findSchema({"_C::fused_add_rms_norm", ""});
  if (!handle.has_value()) {
    ops.def(
  ...
  if (!handle.has_value()) {
    ops.def(
        "rms_norm_static_fp8_quant(Tensor! result, Tensor input, Tensor "
        "weight, "
  ...
  handle =
      c10::Dispatcher::singleton().findSchema({"_C::rotary_embedding", ""});
  if (!handle.has_value()) {
    ops.def(
  ...
  handle = c10::Dispatcher::singleton().findSchema({"_C::aqlm_gemm", ""});
  if (!handle.has_value()) {
    ops.def(
  ...
  handle = c10::Dispatcher::singleton().findSchema({"_C::aqlm_dequant", ""});
  if (!handle.has_value()) {
    ops.def(
  ...
  handle = c10::Dispatcher::singleton().findSchema({"_C::awq_gemm", ""});
  if (!handle.has_value()) {
    ops.def(
  ...
  handle = c10::Dispatcher::singleton().findSchema({"_C::awq_dequantize", ""});
  if (!handle.has_value()) {
    ops.def(
  ...
  handle = c10::Dispatcher::singleton().findSchema({"_C::marlin_gemm", ""});
  if (!handle.has_value()) {
    ops.def(
  ...
  handle =
      c10::Dispatcher::singleton().findSchema({"_C::gptq_marlin_24_gemm", ""});
  if (!handle.has_value()) {
    ops.def(
  ...
  handle = c10::Dispatcher::singleton().findSchema({"_C::machete_mm", ""});
  if (!handle.has_value()) {
    ops.def(
        "machete_mm("
        "   Tensor A,"
  ...
  handle =
      c10::Dispatcher::singleton().findSchema({"_C::machete_prepack_B", ""});
  if (!handle.has_value()) {
    ops.def(
        "machete_prepack_B("
        "   Tensor B,"
  ...
  handle = c10::Dispatcher::singleton().findSchema({"_C::permute_cols", ""});
  if (!handle.has_value()) {
  ...
  handle =
      c10::Dispatcher::singleton().findSchema({"_C::gptq_marlin_gemm", ""});
  if (!handle.has_value()) {
    ops.def(
  ...
  handle =
      c10::Dispatcher::singleton().findSchema({"_C::gptq_marlin_repack", ""});
  if (!handle.has_value()) {
    ops.def(
  ...
  handle =
      c10::Dispatcher::singleton().findSchema({"_C::awq_marlin_repack", ""});
  if (!handle.has_value()) {
    ops.def(
  ...
  handle = c10::Dispatcher::singleton().findSchema({"_C::marlin_qqq_gemm", ""});
  if (!handle.has_value()) {
    ops.def(
  ...
  handle = c10::Dispatcher::singleton().findSchema(
      {"_C::cutlass_scaled_mm_supports_block_fp8", ""});
  if (!handle.has_value()) {
    ops.def(
  ...
  if (!handle.has_value()) {
    ops.def(
        "cutlass_sparse_scaled_mm_supported(int cuda_device_capability) -> "
        "bool");
  }
  ...
  handle = c10::Dispatcher::singleton().findSchema(
      {"_C::cutlass_sparse_compress_entry", ""});
  if (!handle.has_value()) {
    ops.def(
  ...
  handle =
      c10::Dispatcher::singleton().findSchema({"_C::selective_scan_fwd", ""});
  if (!handle.has_value()) {
    ops.def(
  ...
  handle =
      c10::Dispatcher::singleton().findSchema({"_C::causal_conv1d_update", ""});
  if (!handle.has_value()) {
    ops.def(
  ...
  handle =
      c10::Dispatcher::singleton().findSchema({"_C::causal_conv1d_fwd", ""});
  if (!handle.has_value()) {
    ops.def(
  ...
  handle = c10::Dispatcher::singleton().findSchema({"_C::gptq_gemm", ""});
  if (!handle.has_value()) {
    ops.def(
  ...
  handle = c10::Dispatcher::singleton().findSchema({"_C::gptq_shuffle", ""});
  if (!handle.has_value()) {
  ...
  handle = c10::Dispatcher::singleton().findSchema({"_C::awq_gemm_gcu", ""});
  if (!handle.has_value()) {
    ops.def(
        "awq_gemm_gcu(Tensor _in_feats, Tensor _kernel, Tensor "
        "_scaling_factors, "
  ...
  handle = c10::Dispatcher::singleton().findSchema({"_C::gptq_gemm_gcu", ""});
  if (!handle.has_value()) {
    ops.def(
  ...
  handle =
      c10::Dispatcher::singleton().findSchema({"_C::fused_moe_kernel", ""});
  if (!handle.has_value()) {
    ops.def("fused_moe_kernel", &fused_moe_kernel);
  }
  ops.impl("fused_moe_kernel", c10::kPrivateUse1, &fused_moe_kernel);

  handle = c10::Dispatcher::singleton().findSchema({"_C::get_ep_indices", ""});
  if (!handle.has_value()) {
  ...
  handle = c10::Dispatcher::singleton().findSchema(
      {"_C::gelu_tanh_static_int8_quant", ""});
  if (!handle.has_value()) {
  ...
  handle = c10::Dispatcher::singleton().findSchema(
      {"_C::gelu_fast_static_int8_quant", ""});
  if (!handle.has_value()) {
  ...
  handle =
      c10::Dispatcher::singleton().findSchema({"_C::gelu_tanh_asym_quant", ""});
  if (!handle.has_value()) {
    ops.def("gelu_tanh_asym_quant", &gelu_tanh_asym_quant);
  }
  ops.impl("gelu_tanh_asym_quant", c10::kPrivateUse1, &gelu_tanh_asym_quant);

  handle = c10::Dispatcher::singleton().findSchema({"_C::gelu_asym_quant", ""});
  if (!handle.has_value()) {
  ...
  handle =
      c10::Dispatcher::singleton().findSchema({"_C::gelu_new_asym_quant", ""});
  if (!handle.has_value()) {
    ops.def("gelu_new_asym_quant", &gelu_new_asym_quant);
  }
  ops.impl("gelu_new_asym_quant", c10::kPrivateUse1, &gelu_new_asym_quant);

  handle = c10::Dispatcher::singleton().findSchema({"_C::silu_asym_quant", ""});
  if (!handle.has_value()) {
  ...
  handle =
      c10::Dispatcher::singleton().findSchema({"_C::gelu_fast_asym_quant", ""});
  if (!handle.has_value()) {
  ...
  handle = c10::Dispatcher::singleton().findSchema(
      {"_C::static_scaled_int8_asym_quant", ""});
  if (!handle.has_value()) {
  ...
  handle = c10::Dispatcher::singleton().findSchema(
      {"_C::static_scaled_int8_asym_dequant", ""});
  if (!handle.has_value()) {
    ops.def("static_scaled_int8_asym_dequant",
  ...
  handle = c10::Dispatcher::singleton().findSchema({"_C::gelu_mul_quant", ""});
  if (!handle.has_value()) {
  ...
  handle =
      c10::Dispatcher::singleton().findSchema({"_C::gelu_tanh_mul_quant", ""});
  if (!handle.has_value()) {
  ...
  handle = c10::Dispatcher::singleton().findSchema(
      {"_C::layer_norm_static_int8_quant", ""});
  if (!handle.has_value()) {
  ...
  handle = c10::Dispatcher::singleton().findSchema({"_C::linear_quant", ""});
  if (!handle.has_value()) {
    ops.def(
  ...
  handle = c10::Dispatcher::singleton().findSchema(
      {"_C::memory_efficient_attention_alibi", ""});
  if (!handle.has_value()) {
  ...
  handle = c10::Dispatcher::singleton().findSchema({"_C::dispatch_bgmv", ""});
  if (!handle.has_value()) {
  ...
  handle =
      c10::Dispatcher::singleton().findSchema({"_C::fused_grouped_topk", ""});
  if (!handle.has_value()) {
    ops.def(
  ...
  handle = c10::Dispatcher::singleton().findSchema({"_C::dynamic_split", ""});
  if (!handle.has_value()) {
  ...
  handle = c10::Dispatcher::singleton().findSchema(
      {"_C::dynamic_per_token_group_fp8_quant_with_size", ""});
  if (!handle.has_value()) {
    ops.def(
        "dynamic_per_token_group_fp8_quant_with_size(Tensor! out, "
        "Tensor! scale, Tensor input, Tensor real_size, int group_size) "
        "-> ()");
  }
  ...
  handle = c10::Dispatcher::singleton().findSchema(
      {"_C::fused_add_rms_norm_per_token_group_quant_fp8", ""});
  if (!handle.has_value()) {
    ops.def(
  ...
  handle = c10::Dispatcher::singleton().findSchema(
      {"_C::rms_norm_per_token_group_quant_fp8", ""});
  if (!handle.has_value()) {
    ops.def(
  ...
  handle = c10::Dispatcher::singleton().findSchema(
      {"_C::silu_mul_per_token_group_quant_with_size", ""});
  if (!handle.has_value()) {
    ops.def(
  ...
  handle = c10::Dispatcher::singleton().findSchema(
      {"_C::rotary_embedding_with_kv_cache", ""});
  if (!handle.has_value()) {
    ops.def(
  ...
  handle = c10::Dispatcher::singleton().findSchema(
      {"_C::exts_moe_align_block_size", ""});
  if (!handle.has_value()) {
    ops.def(
        "exts_moe_align_block_size(Tensor(a!) sorted_token_ids, "
        "Tensor(a!) experts_ids, "
        "Tensor(a!) num_tokens_post_pad, Tensor topk_ids, Tensor "
        "real_token_num, "
        "Tensor expert_map, int num_experts, int block_size) -> ()");
  }
  ops.impl("exts_moe_align_block_size", torch::kPrivateUse1,
           &exts_moe_align_block_size);

  handle =
      c10::Dispatcher::singleton().findSchema({"_C::merge_attn_states", ""});
  if (!handle.has_value()) {
    ops.def(
  ...
  handle =
      c10::Dispatcher::singleton().findSchema({"_C::fused_qkv_gemm_quant", ""});
  if (!handle.has_value()) {
    ops.def(
  ...
  // topk_topp_random_sampler_from_logits func
  handle = c10::Dispatcher::singleton().findSchema(
    {"_C::topk_topp_random_sampler_from_logits", ""});
  if (!handle.has_value()) {
    ops.def("topk_topp_random_sampler_from_logits(Tensor! output_token_ids, "
      "Tensor logits,Tensor? k, Tensor? p, Tensor exponential, int dim) -> ()");
  }
...
TORCH_LIBRARY_FRAGMENT(CONCAT(_moe, TORCH_EXTENSION_NAME), moe_ops) {
  ...
  handle = c10::Dispatcher::singleton().findSchema({"_moe_C::moe_sum_pad", ""});
  if (!handle.has_value()) {
    moe_ops.def(
