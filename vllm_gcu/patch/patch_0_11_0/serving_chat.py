...
patch("vllm.entrypoints.openai.serving_chat.OpenAIServingChat.chat_completion_stream_generator", \
    chat_completion_stream_generator).start()

patch("vllm.entrypoints.openai.serving_chat.OpenAIServingChat.chat_completion_full_generator", \
    chat_completion_full_generator).start()
