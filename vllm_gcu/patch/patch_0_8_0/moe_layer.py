...
patcher3.start()
# patcher4 = patch("vllm_gcu.models.hunyuan.hunyuan.FusedMoE", PatchedFusedMoE)
# patcher4.start()
patcher5 = patch("vllm_gcu.models.qwen3_moe.qwen3_moe.FusedMoE", PatchedFusedMoE)
patcher5.start()
patcher6 = patch("vllm_gcu.models.mixtral_quant.mixtral_quant.FusedMoE", PatchedFusedMoE)
patcher6.start()