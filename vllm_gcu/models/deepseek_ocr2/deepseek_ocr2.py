...
from vllm.transformers_utils.configs.deepseek_vl2 import DeepseekVLV2Config, MlpProjectorConfig
from vllm_gcu.models.deepseek_ocr2.deepseek_ocr2_processor import(
    BASE_SIZE,
    CROP_MODE,
    IMAGE_SIZE,
...
# from vllm_gcu.models.deepseek_ocr.deepencoder import ImageEncoderViT
