...
_MODEL_LIST = ["baichuan", "cusllama", "glm", "hunyuan", "moose", "deepseek_v3", "deepseek_mtp", "roberta", "got_ocr2", "qwen2_5_vl", "qwen3", "qwen3_moe", "glm4", "deepseek_moe_quant", "mixtral_quant"]
