...
def apply_penalties_opt(logits: torch.Tensor, prompt_tokens_tensor: torch.Tensor,
    ...
    def apply_all_penalties(
        ...
        if isinstance(output_token_ids, torch.Tensor):
            ...
            output_tokens_t = _convert_to_tensors(output_token_ids, vocab_size,
                                                logits.device)
        return apply_penalties_opt(logits, prompt_token_ids, output_tokens_t,
