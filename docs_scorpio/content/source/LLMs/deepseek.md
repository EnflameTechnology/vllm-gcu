...
#### 模型下载
*  url: [DeepSeek-R1-Distill-Qwen-32B](https://www.modelscope.cn/models/deepseek-ai/DeepSeek-R1-Distill-Qwen-32B/)
...
```shell
# 启动服务器
vllm serve "[path of DeepSeek-R1-Distill-Qwen-32B]" \
 --tokenizer=[path of DeepSeek-R1-Distill-Qwen-32B] \
 --dtype=bfloat16 \
...
# 启动客户端
curl "http://127.0.0.1:8000/v1/chat/completions" -H "Content-Type: application/json" -d '{"max_tokens": 500,"messages": [{"role": "system", "content": "You are a helpful assistant."},{"role":"user","content":"李白是谁？"}],"model":"[path of DeepSeek-R1-Distill-Qwen-32B] ","stop": null,"stream": false}'
