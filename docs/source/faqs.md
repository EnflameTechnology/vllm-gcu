...
* Enflame-compatible GCU systems running with **TopsRider ≥ i3x 3.6**
...
vLLM-GCU is implemented as a **plugin** to vLLM using Enflame’s GCU kernel interface. Make sure vLLM-GCU and vLLM use **matching versions** (e.g. `vllm==0.11.0`, `vllm-gcu==0.11.0`).
