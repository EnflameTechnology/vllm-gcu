if ("${CMAKE_SYSTEM_PROCESSOR}" STREQUAL "x86_64")
    ...
    set(_COMMIT_ID 2d30f90)
    set(_VERSION 2.6.3+torch.2.5.1.gcu.3.4.20250730)
    string(REPLACE "torch.2.5.1" "torch.2.7.0" _VERSION "${_VERSION}")
    set(_MNAME      flash_attn)
    set(_SEMI_NAME  "")
    set(_BRANCH master)

    set(fa_torch_version_list 2.7.0)
    ...
    get_version(_TORCH27_VERSION 2.7.0)
    ...
    foreach(_pv ${_PY_VERSIONS})
        ...
        fetchFromArtifactory(fetch_${_MNAME}_${_pv}_27
            FILE ${_link}
            PKG_COMMAND ${PACKAGE_CMDS}
            PKG_FILES ${PACKAGE_FILES}
            PKG_ONLY ON
            BRANCH ${_BRANCH}
            VERSION ${_TORCH27_VERSION}
        )
    endforeach()
endif ()
